...
void DEBUG_display_text(String value, tgx::dVec2 anchor, int text_color, int bg_color, int x, int y) {
...
void DEBUG_potentiometers(POT* pot, int x, int y, int text_color, int bg_color) {
